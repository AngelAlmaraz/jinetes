...
export const loginUrl =
  "https://4nxi7wtmf2.execute-api.us-east-1.amazonaws.com/dev/users/login";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginTop: "10%", width: "100%" }}>
            <div style={{ marginTop: "2%" }}>
              <label style={{ marginLeft: "15%", fontSize: "1.5vw" }}>
                Email
              </label>
            </div>
        ...
        <div>
          <h3 style={{ textAlign: "center", fontSize: "1vw", marginTop: "2%" }}>
